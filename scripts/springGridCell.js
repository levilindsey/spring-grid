...
(function () {
   ...
   * @function SpringGridCell~createElement
   * @param {HTMLElement} parent The parent element that contains this grid cell.
   * @param {HTMLElement} child The child element that this grid cell contains.
   */
  function createElement(parent, child) {
    var cell = this;
    cell.element = util.createElement('div', parent, null, ['gridCell']);
   ...
   * @function SpringGridCell~setUpCSSTransitions
   */
   ...
   * the open grid.
   * @function SpringGridCell#animateToOpen
   */
   ...
   * Starts the animation to move this grid cell from its current position to its position within
   * the closed grid.
   * @function SpringGridCell#animateToClosed
   */
   ...
   * @function SpringGridCell#setPositions
   ...
   * @function SpringGridCell#setTransitionParameters
   ...
   * @param {HTMLElement} child The child element that this grid cell contains.
   */
  function SpringGridCell(parent, child) {
    var cell = this;
    ...
    createElement.call(this, parent, child);
  }
